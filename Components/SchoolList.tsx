...
import { getCityCell, getEditCell, getStreetCell, getWebsiteCell } from "./GenericList";
...
function getLevel(item: ResultItem) {
    ...
    return levels.split(';').map(level => <span key="level" className="tag">{ISCED_LEVELS[level] ?? level}</span>)
